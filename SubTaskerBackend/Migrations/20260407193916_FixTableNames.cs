    ...
    public partial class FixTableNames : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskItemsTags", x => new { x.TaskId, x.TagId });
                    table.ForeignKey(
                        name: "FK_TaskItemsTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskItemsTags_TaskItems_TaskId",
                        column: x => x.TaskId,
